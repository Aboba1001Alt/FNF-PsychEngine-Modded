...
{
	var options:Array<String> = ['Note Colors', 'Controls', 'Adjust Delay and Combo', 'Graphics', 'Visuals and UI', 'Gameplay', 'Experimental'];
	...
	function openSelectedSubstate(label:String) {
		switch(label) {
			...
			case 'Adjust Delay and Combo':
				...
				#end
			case 'Experimental':
				openSubState(new experimental.options.ExperimentalOptions());
			  #if android
				removeVirtualPad();
				#end
		}
